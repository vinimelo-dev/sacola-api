package medio.sacola.Service.Impl;

import lombok.RequiredArgsConstructor;
import medio.sacola.Service.SacolaService;
import medio.sacola.enumeration.FormaPagamento;
import medio.sacola.model.Item;
import medio.sacola.model.Restaurante;
import medio.sacola.model.Sacola;
import medio.sacola.repository.ItemRepository;
import medio.sacola.repository.ProdutoRepository;
import medio.sacola.repository.SacolaRepository;
...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
     ...
     if (sacola.isFechada()){
         throw new RuntimeException("Esta sacola está fechada1");
     }
